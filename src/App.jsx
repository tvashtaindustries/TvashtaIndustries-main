  ...
  return (
    ...
    <div className="container2">
      ...
      <div className="left">
        ...
        <h4>With years of industry exh4erience, we've established ourselves as leaders in providing comprehensive services from architectural design to modular kitchens and industrial structures.</h4>
